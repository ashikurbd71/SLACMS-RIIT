...
export default function Thursday() {
  ...
  return (
    <div className="w-full mb-5 mx-auto">
      ...
      <div className="py-6">
        <h1 className="font-bold text-3xl">Step : 5 - Set here your <span className="text-red-600 text-4xl font-extrabold">Thursday</span> class routine</h1>
