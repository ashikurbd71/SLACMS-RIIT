...
export default function Wednesday() {
  ...
  return (
    <div className="w-full mb-5 mx-auto">
      ...
      <div className="py-6">
        <h1 className="font-bold text-3xl">Step : 4 - Set here your <span className="text-red-600 text-4xl font-extrabold">Wednesday</span> class routine</h1>
...
<div className="flex gap-5 items-center">
            <Link href="/routinedash/tuesdayroutine">
<div
...
Preview : Tuesday
              ...
              <Link href="/routinedash/thursdayroutine">
                <button
                  type="submit"
